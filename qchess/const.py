...
LATE_MOVE_REDUCTION_TABLE = [[int(0.20 * math.log(i) * math.log(j) + 0.7) for j in range(1, LATE_MOVE_REDUCTION_TABLE_SIZE+1)] for i in range(1, LATE_MOVE_REDUCTION_TABLE_SIZE+1)]
...
PIECE_MOBILITY_TABLES = (
    ...
    ( # King
	    (-20, -5, 0, 0, 0, -5, -10, -20, -20, -20),
		(-50, -40, -30, -20, -10, 0, 10, 20, 20, 20)
	),
)
